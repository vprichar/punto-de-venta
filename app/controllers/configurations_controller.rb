class ConfigurationsController < ApplicationController
    ...
    authorize! :read, @configuration
      ...
      if @configuration.update(configuration_params)
        format.html { redirect_to '/configurations', notice: 'La configuración a sido actualizada.' }
    ...
    def set_configuration
      @configuration = StoreConfiguration.find(current_user.store_configuration.id)
    end
